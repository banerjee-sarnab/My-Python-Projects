...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg = pygame.image.load('D:\\Python Projects\\Racing car game\\car.png')
        self.car_x_coordinate = (self.display_width * 0.45)
        self.car_y_coordinate = (self.display_height * 0.8)
        self.car_width = 49

        # enemy_car
        self.enemy_car = pygame.image.load('D:\Python Projects\Racing car game\\enemy_car_1.png')
        ...
        # Background
        self.bgImg = pygame.image.load("D:\\Python Projects\\Racing car game\\back_ground.jpg")
    ...
    def display_credit(self):
        ...
        text = font.render("Sarnab Banerjee", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("sarnabbanerjee02@gmail.com", True, self.white)
